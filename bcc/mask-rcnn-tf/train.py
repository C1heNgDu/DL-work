...
from utils.metrics import IOUScore, FScore, Precision
...
if __name__ == "__main__":
    ...
    iou_metric = IOUScore()
    f1_metric = FScore(beta=1)
    precision_metric = Precision()

    train_gpu = [0, ]

    #classes_path = 'model_data/hh/hh.txt'
    classes_path = 'model_data/hh/hh_classes.txt'
    ...
    train_image_path = "datasets/dataset_hh/JPEGImages"
    train_annotation_path = "datasets/dataset_hh/json_five/train_annotations.json"
    val_image_path = "datasets/dataset_hh/JPEGImages"
    val_annotation_path = "datasets/dataset_hh/json_five/val_annotations.json"
    # train_image_path = "datasets/dataset_hh/JPEGImages"
    # train_annotation_path = "datasets/dataset_hh/json_one/train_annotations.json"
    #
    # val_image_path = "datasets/dataset_hh/JPEGImages"
    # val_annotation_path = "datasets/dataset_hh/json_one/val_annotations.json"
    ...
    if True:
        ...
        train_dataloader = COCODetection(train_image_path, train_coco, num_classes, anchors, batch_size, config,
                                         COCO_LABEL_MAP, Augmentation(config.IMAGE_SHAPE))
        val_dataloader = COCODetection(val_image_path, train_coco, num_classes, anchors, batch_size, config,
                                       COCO_LABEL_MAP, Augmentation(config.IMAGE_SHAPE))
