...
class COCODetection(Sequence):
    def __init__(self, image_path, coco, num_classes, anchors, batch_size, config, COCO_LABEL_MAP=None, augmentation=None):
        if COCO_LABEL_MAP is None:
            COCO_LABEL_MAP = {}
    ...
    def pull_item(self, index):
        #   载入coco序号
        #   根据coco序号载入目标信息
        global boxes, boxes_classes, masks
