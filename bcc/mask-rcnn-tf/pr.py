...
ROOT_DIR = os.getcwd()
MODEL_DIR = os.path.join(ROOT_DIR, "logs/5")
...
# 测试集设置
dataset_root_path = "datasets/dataset_hh/"
img_floder = dataset_root_path + "JPEGImages"
mask_floder = dataset_root_path + "json5"
...
model_path = os.path.join(MODEL_DIR, "ep060-loss0.581-val_loss0.325.h5")  # 修改成自己训练好的模型
